#pragma checksum "C:\PinLocation\pinlocation\Views\Home\Find.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8e3fb1634af34fc44a0bee1e96bc9f34ae12ddc9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8e3fb1634af34fc44a0bee1e96bc9f34ae12ddc9", @"/Views/Home/Find.cshtml")]
...
<script type=""text/javascript"">
    ...
    //    travelMode: google.maps.TravelMode.DRI");
            WriteLiteral(@"VING,
        ...
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            response.routes[0].legs.forEach(function (item, index) {
                if (index < response.routes[0].legs.length - 1) {
                    ...
                    minu");
            WriteLiteral(@"te = parseFloat(minute) + parseFloat(item.duration.value / 60);
